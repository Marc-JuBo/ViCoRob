...
blended_image_p1 = cv2.addWeighted(result12, alpha, image2, 1 - alpha, 0)
blended_image_final = cv2.addWeighted(result32, alpha, blended_image_p1, 1 - alpha, 0)

# Display the blended image
cv2.imwrite(project_folder + '4.merged_alpha_partially.jpeg', blended_image_p1)
cv2.imwrite(project_folder + '4.merged_alpha.jpeg', blended_image_final)
