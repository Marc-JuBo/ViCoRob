...
# Load the images
image1 = cv2.imread(project_folder + '1.left.png')
image2 = cv2.imread(project_folder + '1.right.png')

translation = np.float32([[1, 0, 130],[0, 1, 80],[0, 0, 1]])
size_x = image2.shape[1]+150
